...
import cd.go.contrib.elasticagents.awsecs.executors.GetPluginConfigurationExecutor;
import cd.go.contrib.elasticagents.awsecs.executors.GetViewRequestExecutor;
import cd.go.contrib.elasticagents.awsecs.requests.*;
...
@Extension
public class AwsEcsPlugin implements GoPlugin {
    ...
    public static final Logger LOG = Logger.getLoggerFor(AwsEcsPlugin.class);
