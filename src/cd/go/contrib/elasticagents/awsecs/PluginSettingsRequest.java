...
public class PluginSettingsRequest {
    ...
    private final AwsEcsPlugin dockerPlugin;

    public PluginSettingsRequest(AwsEcsPlugin dockerPlugin) {
        this.dockerPlugin = dockerPlugin;
    }

    public PluginSettings getConfiguration() {
        DefaultGoApiRequest request = new DefaultGoApiRequest(Constants.REQUEST_SERVER_GET_PLUGIN_SETTINGS, AwsEcsPlugin.API_VERSION, AwsEcsPlugin.PLUGIN_IDENTIFIER);
